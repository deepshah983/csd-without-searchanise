...
import CsdLayBuy from './csd/laybuy';
// import csdCart from './csd/cart';
...
export default class Cart extends PageManager {
    onReady() {
        ...
        // CSD EDIT
        // CsdLayBuy.run( $('[data-cart-totals]') )
        CsdLayBuy.run( $('.page-cart') )
        csdCart.load(this.context);
    }
    ...
    cartUpdate($target) {
        ...
        const newQty = $('select[data-cart-itemid='+ itemId +']').val();
    ...
    bindCartEvents() {
        ...
        // cart update
        $('[data-cart-update]', this.$cartContent).on('change', event => {
